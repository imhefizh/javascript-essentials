const employees = [
    ...
    { id: 4, name: 'Maulana Hafidz', age: 23, department: 'IT', salary: 80000 },
];

document.getElementById('find-emp').onsubmit = (event) => event.preventDefault();
document.getElementById('btn').onclick = () => {
    findEmployeeById(parseInt(document.getElementById('input').value));
